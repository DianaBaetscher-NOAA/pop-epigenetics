...
This is without the spike-in! Supposedly EM-sequencing spike in is
either (or both?) unmethylated Lambda DNA and CpG-methylated pUC19 DNA.
I searched in the bam files for lambda and pUC19, but it doesn’t seem
like seqmatic added that to the ref genome. So that means I should
...
Analyses continue in `Bismark_to_Clock.Rmd` but aren’t developed just
yet.
...
I am running into issues with methylkit::unite because of Out-of-Mem,
running on himem node.
