...
Actually the bam files are already
...
# below didn't work
#bismark prepare ~/reference_genomes/sebastes_alutus/SebastesalutusPOP6.ragtag.scaffold.fasta
```
...
PROJDIR="/scratch2/nhowe/epi-pop/fromBAMs"
REFGENOMEFOLDER="/home/nhowe/reference_genomes/sebastes_alutus/"
BAMSFILE=${PROJDIR}/scripts/epi-pop_sort_dedup_seqmaticBAMs.txt
...
echo "start dedup for ${bam}"
deduplicate_bismark --multicore 10 \
  --paired ${bam}

echo "-- dedup done for ${bam}"

echo "-- start methylation extraction for ${bam}"
echo "--- Parameters: ignore=10, ignore_r2=10 --no_dovetail"
...
#SBATCH --array=2-48%12 # 48 samples
...
Analyses continue in `filtered-bed-to-clock.Rmd`
